             ...
             <section>
                ...
                <div class="fond">
                        <h2>
                            ...
                            <p>L'élément titre définit le titre du document (qui est affiché dans la barre de titre du navigateur ou dans l'onglet de la page). Cet élément ne peut contenir que du texte, les balises qu'il contiendrait seraient ignorées.Pourquoi définir des titres et des paragraphes ?
                                <BR> Une nouvelle fois, rappelez vous que le HTML est un langage de balisage.
                            <br>
